...
class FinanceManager {
    ...
    calculateTotals() {
        ...
        const savedAmount = totalEarnings * 0.1; // 10% of earnings
        const availableBalance = (totalEarnings * 0.9) - totalExpenses; // 90% of earnings minus expenses
    ...
    checkSpendingAlert(totals) {
        ...
        } else if (totals.availableBalance < totals.totalEarnings * 0.1) {
